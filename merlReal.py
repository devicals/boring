...
while True:
    ...
    while True:
        ...
        if user_input == "/help":
            ...
            if "minecraft" not in list(user_input.lower()):
                smartness = random.choices([
                    "I don\'t know. or I don20 know. or I don00t know. or I don20t know or I don00 know.",
            ...
            elif "minecraft" in list(user_input.lower()):
                smartness = random.choices([
                    "I don\'t know. or I don20 know. or I don00t know. or I don20t know or I don00 know.",
                    "Your last message violated our content policy.",
                    "A semi-accurate/correct answer based on technicality or only half correct by missing out certain details or miscounting"
            ...
            try:
                ...
                print("\nMerl: Your last message violated our content policy.\n")